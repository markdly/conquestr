...
#' \code{"ex1_05.pv"} and \code{"ex1_10.pv"} which requests the plausible values example file with 5 or 10 pvs per case respectively. An example file generated by the ConQuest \code{show} command is \code{"ex1.shw"}.
...
#'
#' @export
cq_example <- function(n = 10, display = TRUE, example_name = c("ex1.itn", "ex1_05.pv", "ex1_10.pv", "ex1.shw")) {
